...
class AdaptVQE():
    ...
    def __init__(self, pool, molecule, max_adapt_iter, max_opt_iter, 
        ...
        h1 = 0.0124366 * QubitOperator('Y3 Y2 X1') - 0.0279419 * QubitOperator('Y3 Y2 X1 X0') + 0.0124366 * QubitOperator('Y3 Y2 X1 Z0')

        h2 = - 0.0019804 * QubitOperator('X2 Y1 Y0') - 0.0279419 * QubitOperator('X3 X2 Y1 Y0') - 0.0019804 * QubitOperator('Z3 X2 Y1 Y0')

        h3 = 0.0279419 * QubitOperator('Y3 Y2 Y1 Y0')

        h4 = - 0.0130951 * QubitOperator('Y1 Y0') + 0.0211245 * QubitOperator('Z2 Y1 Y0') + 0.0124366 * QubitOperator('X3 Y1 Y0') \
        - 0.0124366 * QubitOperator('X3 Z2 Y1 Y0') - 0.00459719 * QubitOperator('Z3 Y1 Y0') - 0.00343219 * QubitOperator('Z3 Z2 Y1 Y0')

        h5 = - 0.0130951 * QubitOperator('Y3 Y2') - 0.0019804 * QubitOperator('Y3 Y2 X0') - 0.0211245 * QubitOperator('Y3 Y2 Z0') \
        + 0.00459719 * QubitOperator('Y3 Y2 Z1') + 0.0019804 * QubitOperator('Y3 Y2 Z1 X0') - 0.00343219 * QubitOperator('Y3 Y2 Z1 Z0')

        h6 = 0.0019804 * QubitOperator('X2 X1 X0') + 0.0279419 * QubitOperator('X3 X2 X1 X0') + 0.0019804 * QubitOperator('Z3 X2 X1 X0')

        h7 = - (0.0152095 * QubitOperator('X2 X1') + 0.0152095 * QubitOperator('X2 X1 Z0') + 0.0124366 * QubitOperator('X3 X2 X1') \
        + 0.0124366 * QubitOperator('X3 X2 X1 Z0') + 0.0152095 * QubitOperator('Z3 X2 X1') + 0.0152095 * QubitOperator('Z3 X2 X1 Z0'))

        h8 = 0.0130951 * QubitOperator('X1 X0') - 0.0211245 * QubitOperator('Z2 X1 X0') - 0.0124366 * QubitOperator('X3 X1 X0') \
        + 0.0124366 * QubitOperator('X3 Z2 X1 X0') + 0.00459719 * QubitOperator('Z3 X1 X0') + 0.00343219 * QubitOperator('Z3 Z2 X1 X0')

        h9 = - 0.0223649 * QubitOperator('X1') - 0.0223649 * QubitOperator('X1 Z0') + 0.0214908 * QubitOperator('Z2 X1') \
        + 0.0214908 * QubitOperator('Z2 X1 Z0') + 0.0165101 * QubitOperator('X3 X1') + 0.0165101 * QubitOperator('X3 X1 Z0') \
        - 0.0165101 * QubitOperator('X3 Z2 X1') - 0.0165101 * QubitOperator('X3 Z2 X1 Z0') - 0.00857088 * QubitOperator('Z3 X1') \
        - 0.00857088 * QubitOperator('Z3 X1 Z0') + 0.00607138 * QubitOperator('Z3 Z2 X1') + 0.00607138 * QubitOperator('Z3 Z2 X1 Z0')

        h10 = 0.0195265 * QubitOperator('X2 X0') - 0.0195265 * QubitOperator('X2 Z1 X0') + 0.0019804 * QubitOperator('X3 X2 X0') \
            - 0.0019804 * QubitOperator('X3 X2 Z1 X0') + 0.0195265 * QubitOperator('Z3 X2 X0') - 0.0195265 * QubitOperator('Z3 X2 Z1 X0')

        h11 = 0.016699 * QubitOperator('X2') + 0.024665 * QubitOperator('X2 Z0') - 0.0981459 * QubitOperator('X2 Z1') \
            - 0.0184858 * QubitOperator('X2 Z1 Z0') + 0.0130951 * QubitOperator('X3 X2') + 0.0211245 * QubitOperator('X3 X2 Z0') \
            - 0.00459719 * QubitOperator('X3 X2 Z1') + 0.00343219 * QubitOperator('X3 X2 Z1 Z0') + 0.016699 * QubitOperator('Z3 X2') \
            + 0.024665 * QubitOperator('Z3 X2 Z0') - 0.0981459 * QubitOperator('Z3 X2 Z1') - 0.0184858 * QubitOperator('Z3 X2 Z1 Z0')

        h12 = 0.016699 * QubitOperator('X0') - 0.016699 * QubitOperator('Z1 X0') - 0.024665 * QubitOperator('Z2 X0') \
            + 0.024665 * QubitOperator('Z2 Z1 X0') - 0.0152095 * QubitOperator('X3 X0') + 0.0152095 * QubitOperator('X3 Z1 X0') \
            + 0.0152095 * QubitOperator('X3 Z2 X0') - 0.0152095 * QubitOperator('X3 Z2 Z1 X0') + 0.0981459 * QubitOperator('Z3 X0') \
            - 0.0981459 * QubitOperator('Z3 Z1 X0') - 0.0184858 * QubitOperator('Z3 Z2 X0') + 0.0184858 * QubitOperator('Z3 Z2 Z1 X0')

        h13 = (-7.25623 +
                -0.102801 * QubitOperator('Z0') +
                0.202775 * QubitOperator('Z1') +
                -0.164495 * QubitOperator('Z1 Z0') +
                0.102801 * QubitOperator('Z2') +
                -0.0977784 * QubitOperator('Z2 Z0') +

                0.0815464 * QubitOperator('Z2 Z1') +
                -0.0596316 * QubitOperator('Z2 Z1 Z0') +
                -0.0223649 * QubitOperator('X3') +
                -0.0214908 * QubitOperator('X3 Z0') +
        
                +0.00857088 * QubitOperator('X3 Z1') +
                + 0.00607138 * QubitOperator('X3 Z1 Z0') +
                + 0.0223649 * QubitOperator('X3 Z2') +
                + 0.0214908 * QubitOperator('X3 Z2 Z0') +
                
                - 0.00857088 * QubitOperator('X3 Z2 Z1') +
                - 0.00607138 * QubitOperator('X3 Z2 Z1 Z0') +
                - 0.202775 * QubitOperator('Z3') +
                + 0.0815464 * QubitOperator('X3 Z0') +
                
                - 0.0800052 * QubitOperator('Z3 Z1') +
                + 0.0642967 * QubitOperator('Z3 Z1 Z0') +
                - 0.164495 * QubitOperator('Z3 Z2') +
                + 0.0596316 * QubitOperator('Z3 Z2 Z0') +

                - 0.0642967 * QubitOperator('Z3 Z2 Z1') +
                + 0.0717285 * QubitOperator('Z3 Z2 Z1 Z0')
            )
        h = [h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13]

        self.qubit_hamiltonian = sum(h)
        ...
        self.commuted_hamiltonian = [ to_qiskit_operator(i) for i in h ]

        print(len(self.commuted_hamiltonian))

        print(self.commuted_hamiltonian[0])

        # breakpoint()
        
        self.exact_energy = -7.793274300660553
